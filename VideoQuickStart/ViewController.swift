...
class ViewController: UIViewController {
    ...
    @IBAction func setDefaultMessageLabel(_ sender: Any) {
        test_label.text = "Default message"
    }
    ...
    var socket = SocketIOClient(socketURL: URL(string: "https://2268983d.ngrok.io")!, config: [.log(false), .forcePolling(true)])
    var temp_word: String = ""
    
    var accessToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCIsImN0eSI6InR3aWxpby1mcGE7dj0xIn0..w5yEjM407NRICg2P9SkSxxHZyo7qlMKRTEJRE-6xNtI"
    ...
    override func viewDidLoad() {
        ...
        // socket is listening, not connected yet
        socket.on("test") { dataArray, ack in
            ...
            print("temp_word: ", self.temp_word)
                self.test_label.text = self.temp_word
            }
        }
